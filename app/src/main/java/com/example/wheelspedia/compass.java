...
public class compass extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slideModels.add(new SlideModel("https://stimg.cardekho.com/images/carexteriorimages/930x620/Jeep/Compass/8968/Jeep-Compass-2.0L-Night-Eagle-Diesel/1650341271476/front-left-side-47.jpg?imwidth=890&impolicy=resize", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://stimg.cardekho.com/images/carinteriorimages/930x620/Jeep/Compass/8968/1650341415794/steering-wheel-54.jpg?imwidth=890&impolicy=resize", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://imgd.aeplcdn.com/370x208/n/cw/ec/47051/compass-exterior-right-front-three-quarter-73.jpeg?isig=0&q=75", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://media.zigcdn.com/media/model/2023/Feb/front-1898188403_930x620.jpg", ScaleTypes.FIT));
        ...
        String imageUrl6 ="https://stimg.cardekho.com/images/expert-review/jeep-compass-2020/1610009168724/221X147/Jeep-Compass-2020-0.jpg";
        ImageView imageView6 = findViewById(R.id.sof1);
        Picasso.get().load(imageUrl6).fit().centerCrop().into(imageView6);

        String imageUrl7 = "https://stimg.cardekho.com/images/expert-review/jeep-compass-2020/1610009251843/221X147/Jeep-Compass-2020-0.jpg";
        ImageView imageView7 = findViewById(R.id.sof2);
        Picasso.get().load(imageUrl7).fit().centerCrop().into(imageView7);

        String imageUrl8 = "https://stimg.cardekho.com/images/expert-review/jeep-compass-2020/1610009360613/221X147/Jeep-Compass-2020-0.jpg";
