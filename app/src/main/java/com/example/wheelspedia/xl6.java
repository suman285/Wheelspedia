...
public class xl6 extends AppCompatActivity {
    ImageSlider imageSlider;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_xl6);
        imageSlider = findViewById(R.id.alto800_slider);
        ArrayList<SlideModel> slideModels = new ArrayList<>();

        slideModels.add(new SlideModel("https://stimg.cardekho.com/images/carexteriorimages/930x620/Maruti/XL6/10384/1688385191052/front-left-side-47.jpg?imwidth=890&impolicy=resize", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://stat.overdrive.in/wp-content/uploads/2022/04/2022-XL-6-25-scaled-e1650902369813.jpg", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://img.indianautosblog.com/2019/08/22/maruti-xl6-vs-ertiga-interiors-2-dfd1.jpg", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://www.motorbeam.com/wp-content/uploads/Maruti-XL6-5.jpg", ScaleTypes.FIT));
        slideModels.add(new SlideModel("https://www.haribhoomi.com/h-upload/2022/04/21/1461378-marutisuzukixl6.jpg", ScaleTypes.FIT));
        ...
        String imageUrl6 ="https://stimg.cardekho.com/images/expert-review/maruti-xl6/1650628416869/221X147/Maruti-XL6-0.jpg";
        ImageView imageView6 = findViewById(R.id.sof1);
        Picasso.get().load(imageUrl6).fit().centerCrop().into(imageView6);

        String imageUrl7 = "https://stimg.cardekho.com/images/expert-review/maruti-xl6/1650628826062/221X147/Maruti-XL6-0.jpg";
        ImageView imageView7 = findViewById(R.id.sof2);
        Picasso.get().load(imageUrl7).fit().centerCrop().into(imageView7);

        String imageUrl8 = "https://stimg.cardekho.com/images/expert-review/maruti-xl6/1650875537324/221X147/Maruti-XL6-0.jpg";
